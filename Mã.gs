...
function onOpen() {
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addItem('🔎 Xem đơn vị "Đã rà soát" nhưng thiếu dữ liệu', 'menuXemTruocRaSoatLai')
    .addItem('♻️ Đặt lại trạng thái rà soát (đơn vị thiếu dữ liệu)', 'menuRaSoatLaiTrangThai')
    .addSeparator()
